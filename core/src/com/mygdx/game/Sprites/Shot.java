...
public class Shot extends Sprite {
     ...
     public Body b2body;
     public Shot (PlayScreen screen, float x, float y, boolean fireRight){
          ...
          for(int i = 0; i < 2; i++) frames.add(sprite[0][i]);
     ...
     public void defineFireBall(){
          ...
          fdef.filter.categoryBits = Jojo.BULLET_BIT;
          fdef.filter.maskBits = Jojo.GROUND_BIT | Jojo.ENEMY_BIT;
     ...
     public void update(float dt){
          ...
          stateTime += dt;
          currentSprite = shotAnim.getKeyFrame(stateTime);
